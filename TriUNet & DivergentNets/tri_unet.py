...
parser.add_argument("--train_CSVs", 
                    nargs="+",
                    default=["/content/drive/MyDrive/DivergentNets/divergent-nets-main/dataset/C1.csv",
                     "/content/drive/MyDrive/DivergentNets/divergent-nets-main/dataset/C2.csv",
                    "/content/drive/MyDrive/DivergentNets/divergent-nets-main/dataset/C3.csv",
                    "/content/drive/MyDrive/DivergentNets/divergent-nets-main/dataset/C4.csv",
                    "/content/drive/MyDrive/DivergentNets/divergent-nets-main/dataset/C5.csv",
                    "/content/drive/MyDrive/DivergentNets/divergent-nets-main/dataset/seq1_neg.csv",
                    "/content/drive/MyDrive/DivergentNets/divergent-nets-main/dataset/seq2_neg.csv",
                    "/content/drive/MyDrive/DivergentNets/divergent-nets-main/dataset/seq3_neg.csv",
                    "/content/drive/MyDrive/DivergentNets/divergent-nets-main/dataset/seq4_neg.csv",
                    "/content/drive/MyDrive/DivergentNets/divergent-nets-main/dataset/seq5_neg.csv"],
                    help="CSV file list with image and mask paths")

parser.add_argument("--val_CSVs",
                    nargs="+",
                    default=["/content/drive/MyDrive/DivergentNets/divergent-nets-main/dataset/seq1.csv",
                             "/content/drive/MyDrive/DivergentNets/divergent-nets-main/dataset/seq2.csv",
                             "/content/drive/MyDrive/DivergentNets/divergent-nets-main/dataset/seq3.csv",
                             "/content/drive/MyDrive/DivergentNets/divergent-nets-main/dataset/seq4.csv",
                             "/content/drive/MyDrive/DivergentNets/divergent-nets-main/dataset/seq5.csv",
                             "/content/drive/MyDrive/DivergentNets/divergent-nets-main/dataset/seq6.csv",
                             "/content/drive/MyDrive/DivergentNets/divergent-nets-main/dataset/seq7.csv",
                             "/content/drive/MyDrive/DivergentNets/divergent-nets-main/dataset/seq8.csv",
                             "/content/drive/MyDrive/DivergentNets/divergent-nets-main/dataset/seq9.csv",
                             "/content/drive/MyDrive/DivergentNets/divergent-nets-main/dataset/seq10.csv",
                             "/content/drive/MyDrive/DivergentNets/divergent-nets-main/dataset/seq6_neg.csv",
                             "/content/drive/MyDrive/DivergentNets/divergent-nets-main/dataset/seq7_neg.csv",
                             "/content/drive/MyDrive/DivergentNets/divergent-nets-main/dataset/seq8_neg.csv",
                             "/content/drive/MyDrive/DivergentNets/divergent-nets-main/dataset/seq9_neg.csv",
                             "/content/drive/MyDrive/DivergentNets/divergent-nets-main/dataset/seq10_neg.csv",],
            
                    help="CSV file list with image and mask paths")

parser.add_argument("--test_CSVs",
                    nargs="+",
                    default="/content/drive/MyDrive/DivergentNets/divergent-nets-main/dataset/C6.csv",
                    help="CSV file list with image and mask paths")



parser.add_argument("--out_dir", 
                    default="/content/drive/MyDrive/DivergentNets/divergent-nets-main/output_dir",
                    help="Main output dierectory")

parser.add_argument("--tensorboard_dir", 
                    default="/content/drive/MyDrive/DivergentNets/divergent-nets-main/tensorboard_dir",
                    help="Folder to save output of tensorboard")



parser.add_argument("--test_out_dir",
                   default= "/content/drive/MyDrive/DivergentNets/divergent-nets-main/test_data_predictions",
...
parser.add_argument("--num_test_samples", type=int, default=6, help="Number of samples to test.")
...
def do_test(opt):
    ...
    for i in range(opt.num_test_samples):
        ...
        fig.savefig(f"./test_{i}.jpg",bbox_inches='tight',pad_inches=0)
